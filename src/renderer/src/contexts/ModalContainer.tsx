...
export function ModalProvider({ children }) {
  ...
  return (
    <ModalContext.Provider value={{ handleContentModal, handleCustomizeModal }}>
      ...
      >
        <div className={`flex flex-col items-center border-base-600 px-4 bg-base-100 h-[80%] w-full mx-8 rounded-md border-[1px]`}>
          <header
          ...
          <div className="flex justify-center text-center h-10 my-3 w-[80%]">
            {buttonLeft ?
              <div
